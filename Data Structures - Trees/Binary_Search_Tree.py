        ...
        if self.root is None:
            ...
            '''RIGHT
                (data)
                    ...
                    newNode
            '''
            while (currentNode.leftNode != newNode) and (currentNode.rightNode != newNode):  # While loop that runs as long as the node-shaped marker's left or right arrow is not connected to newNode
                # Right path
